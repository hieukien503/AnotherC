...
if not './main/AnotherC/parser/' in sys.path:
    sys.path.append('./main/AnotherC/parser/')
if os.path.isdir('../target/main/AnotherC/parser') and not '../target/main/AnotherC/parser/' in sys.path:
    sys.path.append('../target/main/AnotherC/parser/')
from AnotherCLexer import AnotherCLexer
    ...
    def check(soldir, asttree, num):
        ...
        try:
            ...
            subprocess.call("java  -jar " + JASMIN_JAR + " " + path +
                            "/AnotherCClass.j", shell=True, stderr=subprocess.STDOUT)

            subprocess.run("java -cp ./lib:. AnotherCClass",
