...
class Visitor(ABC):
    ...
    def visitCharType(self, ast, param): pass
    def visitStructType(self, ast, param): pass
    def visitDoubleType(self, ast, param): pass

    def visitBinExpr(self, ast, param): pass
    def visitUnExpr(self, ast, param): pass
    def visitTernaryExpr(self, ast, param): pass
    ...
    def visitDoubleLit(self, ast, param): pass
    def visitMemberAccess(self, ast, param): pass
    def visitCharLit(self, ast, param): pass
    def visitNewExpr(self, ast, param): pass
    ...
    def visitStructDecl(self, ast, param): pass
